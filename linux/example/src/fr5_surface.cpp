...
int main(void) {
  ...
  printf("xyz is: %f, %f, %f; rpy is: %f, %f, %f\n", center_pose.tran.x,
         center_pose.tran.y, center_pose.tran.z, center_pose.rpy.rx,
         center_pose.rpy.ry, center_pose.rpy.rz);

  // robot.FT_CalCenterEnd(&dcenter);
  // printf("xcenter:     %f, %f, %f, %f, %f, %f\n", dcenter.tran.x,
  // dcenter.tran.y, dcenter.tran.z, dcenter.rpy.rx, dcenter.rpy.ry,
  // dcenter.rpy.rz);
