...
int main(void)
{
    ...
    // desc_pos = {14.013096 + 50, -518.617126, 339.769684, -164.425659, -20.019272, 166.569366};
    ...
    int ret0 = robot.GetForwardKin(&j1, &desc_pos); // The forward kinematic interface can be used to solve Cartesian space coordinates with only joint positions
    printf("ForwardKinematics is:  x %f\t  y %f\t  z %f\t rx %f\t ry %f\t rz %f \n", desc_pos.tran.x, desc_pos.tran.y, desc_pos.tran.z, desc_pos.rpy.rx, desc_pos.rpy.ry, desc_pos.rpy.rz);
    printf("\n");

    int ret = robot.GetInverseKin(0, &desc_pos, -1, &j4);
    printf("JointPositions are  : J1 %f\t J2 %f\t J3 %f\t J4 %f\t J5 %f\t J6 %f\t \n", j1.jPos[0], j1.jPos[1], j1.jPos[2], j1.jPos[3], j1.jPos[4], j1.jPos[5]);
    printf("GetInverseKin result: J1 %f\t J2 %f\t J3 %f\t J4 %f\t J5 %f\t J6 %f\t \n", j4.jPos[0], j4.jPos[1], j4.jPos[2], j4.jPos[3], j4.jPos[4], j4.jPos[5]);
    printf("\n");
